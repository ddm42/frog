...
/// Incompressible Mooney-Rivlin hyperelasticity (and initially isotropic)
///
...
class ComputeMooneyRivlinStress2 : public ComputeLagrangianStressPK2
{
public:
  static InputParameters validParams();
  ComputeMooneyRivlinStress2(const InputParameters & parameters);
